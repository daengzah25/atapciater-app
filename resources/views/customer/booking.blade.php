    ...
    <style>
        ...
        * {
        ...
        .qty-input {
            ...
            text-align: center;
            font-weight: 500;
            /* prevent native number spinner showing and ensure proper sizing */
            -moz-appearance: textfield;
            appearance: textfield;
            padding: 0.4rem 0.5rem;
        }

        /* Hide webkit number input spinners (Chrome, Safari, Edge, Opera) */
...
<body>
    ...
    <div class="page-content">
        <div class="container">
            ...
            <div class="booking-card fade-in">
                ...
                <form id="bookingForm" action="{{ route('customer.booking.submit') }}" method="POST"
                    ...
                    <!-- Ganti bagian form group tanggal -->
                    <div class="form-group">
                        <label for="tanggal_booking">Tanggal Booking *</label>
                        <input type="text" id="tanggal_booking" name="tanggal_booking" required
                            placeholder="Pilih tanggal booking" readonly
                            style="background-color: white; cursor: pointer;">
                        <small class="text-muted">Tanggal libur dan weekend tidak tersedia</small>
                    </div>
                    ...
                    <div id="addons-container">
                        @foreach ($addons as $addon)
                            <div class="addon-item" data-addon-id="{{ $addon->id_addons }}"
                                data-addon-price="{{ $addon->harga }}" data-addon-stock="{{ $addon->stok }}">
                                <div class="addon-info">
                                    <div class="addon-name">{{ $addon->nama_addons }}</div>
                                    <div class="addon-price">Rp {{ number_format($addon->harga, 0, ',', '.') }} / unit
                                    </div>
                                ...
                                <div class="quantity-controls">
                                    <button type="button" class="qty-btn minus"
                                        data-addon-id="{{ $addon->id_addons }}">-</button>
                                    <input type="number" class="qty-input" id="qty-{{ $addon->id_addons }}"
                                        name="addons[{{ $addon->id_addons }}]" value="0" min="0"
                                        max="{{ $addon->stok }}" readonly>
                    ...
                    <div class="bank-info">
                        <div class="bank-card">
                            ...
                            <div class="bank-details">
                                <div class="bank-item">
                                    ...
                                    <button class="copy-btn" data-text="0551650072">
                        ...
                        <div class="bank-notice">
                            <p><i class="fas fa-info-circle"></i> <strong>Penting:</strong> Harap transfer sesuai
                                dengan total pembayaran yang tertera di bawah. Simpan bukti transfer untuk diupload.</p>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Format tanggal libur untuk flatpickr
            ...
            const flatpickrInstance = flatpickr("#tanggal_booking", {
                ...
                locale: "id",
                disable: [
                    // Disable hari Minggu (0 = Minggu, 6 = Sabtu)
                    function(date) {
                        return date.getDay() === 0;
                    },
                    // Disable tanggal libur
                    ...disabledDates
                ],
                onDayCreate: function(dObj, dStr, fp, dayElem) {
                    // Styling untuk hari yang disabled
            ...
            document.getElementById('bookingForm').addEventListener('submit', function(e) {
                const selectedDate = document.getElementById('tanggal_booking').value;
                ...
                // Validasi manual untuk memastikan tanggal tidak libur
        ...
        // Quantity controls dengan validasi stok
        ...
        document.getElementById('bookingForm').addEventListener('submit', function(e) {
            ...
            document.querySelectorAll('.addon-item').forEach(item => {
                ...
                if (quantity > maxStock) {
                    ...
                    alert('Stok untuk ' + addonName + ' tidak mencukupi! Stok tersedia: ' + maxStock);
                }
            });
